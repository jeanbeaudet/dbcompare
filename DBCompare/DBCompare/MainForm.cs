...
namespace DBCompare
{
    ...
    public partial class MainForm : Form, ICheckChangedListener
    {
        ...
        private const string YouTubePath = "https://www.youtube.com/watch?v=phItu2UQ0co";
        #endregion
        ...
        #region Events
            ...
            {
                // send the user to the Data Juggler web page
                MessageBoxHelper.ShowMessage("The Data Juggler website is currently down. If you need assitance please contact me at corby@datajuggler.com", "A Message From Data Juggler");
            }
            #endregion
        ...
        #region Methods
            ...
            public void Init()
            {
                ...
                // Get the next random banner
                this.BannerControl.ChangeBanner();
            }
            #endregion
