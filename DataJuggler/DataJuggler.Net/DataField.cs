...
namespace DataJuggler.Net
{
	...
	/// <summary>
	/// DataField Object Used For DataClassBuilder.Net
	/// </summary>
	[Serializable]
		...
		#region Methods
			...
			#region Clone() +2 override
				...
				public DataField Clone(bool includeFieldValue, bool loading)
				{
					...
					// Do Not Clone field Value If IgnoreFieldValue = false
			...
			{
				// If IgnoreChanges = True, Loading Is Set To True To
		...
		#region Properties
            ...
            public DataManager.DataTypeEnum DataType
			{
				...
				set
				{
					...
					// testing only
					if(datatype == DataManager.DataTypeEnum.NotSupported)
					{
					    // stop here
					    int x = 0;
					    int y = x;
