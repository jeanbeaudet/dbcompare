...
namespace DataJuggler.Net
{
	...
	public class SQLDatabaseConnector
	{
		...
		#region Methods
            ...
            /// DataFieldsCollection was replaced with
            ...
            /// This was needed after the DataFieldsCollection was removed
            ...
            /// </summary>
            /// <param name="procedureName">The name of the procedure to find depencies for</param>
            ...
            public int FindPrimaryKeysCount(List<DataTable> depencies)
            {
                ...
                // If the depencies collection exists and has one or more items
			...
			#region LoadDataRows() +1 overrides
                ...
                private List<DataRow> LoadDataRowsWithoutBinaryData(DataTable dataTable)
                {
                    ...
                    foreach (System.Data.DataRow tempDataRow in dataSet.Tables[dataTable.Name].Rows)
                    {
                        ...
                        dataRow.Fields = CloneFields(dataTable.Fields);

                        // Add Each field
                        foreach (DataJuggler.Net.DataField field in dataTable.Fields)
                        {
                            // Finding field Index
            ...
            #region LoadStoredProcedureWithSchema(StoredProcedure sourceStoredProcedure, List<DataTable> depencies)
            /// <summary>
            /// This method loads the Schema returned from a stored procedure
            /// </summary>
            /// <param name="procedureName"></param>
            public StoredProcedure LoadStoredProcedureWithSchema(StoredProcedure sourceStoredProcedure, List<DataTable> depencies)
            {
                // initial value
                StoredProcedure storedProcedure = new StoredProcedure();

                // local
                int dependentPrimaryKeysCount = FindPrimaryKeysCount(depencies);
                            ...
                            else
                            {
                                ...
                                if (!hidden)
                                {
                                    ...
                                    if (primaryKeysFound < dependentPrimaryKeysCount)
                                    {
                                        ...
                                        // is a PrimaryKey in one of the depencies, than this field is set as a PrimaryKey
                                        field.PrimaryKey = IsFieldAPrimaryKey(field.FieldName, depencies);
